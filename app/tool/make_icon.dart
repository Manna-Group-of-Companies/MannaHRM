...
//
// Lifted whole from the field-sales app's `tool/make_icon.dart`, logo included:
// it is the same lockup, the same launcher, and the same trap. Two apps on one
// phone from one company should not have two differently-cropped versions of
// the mark.
//
