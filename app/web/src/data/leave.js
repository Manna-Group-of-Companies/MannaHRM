...
export const APPLY_FIELDS = [
  ...
  ["Attachment", "File", "none",
   "Their form takes a file. Attaching one writes a <code>File</code> row on the site and links it to the application, and this page proxies GET only &mdash; see <code>app/serve.js</code>"],
