...
export const SREG_OPTIONS = [
  ...
  ["bank", "Auto Correct Bank Account Number", false,
   ...
   + "switched on anywhere. This page proxies GET only (<code>app/serve.js</code>), so it cannot "
...
export const BT_ACTIONS = [
  ["amounts", "Show Amounts", "\u{1F441}",
   ...
   + "on the proxy's allowlist (<code>app/serve.js</code>), and no slip has ever been generated "
