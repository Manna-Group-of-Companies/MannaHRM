/* Formatting, all of it pure and none of it importing React.
   ...
   These moved out of the page for the same reason `manna_hr/rules.py` is a
   module with no `frappe` import: a rule about how a date is written should be
   arguable without a browser. See CLAUDE.md §3. */
