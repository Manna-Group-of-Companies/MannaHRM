	...
	function button(k) {
		...
		set({
			ctcMsg:
				...
				+ "This API writes only what <code>server/src/doctypes/registry.ts</code> names, field by "
				+ "field — and neither <code>ctc</code> nor anything else that decides what a person is paid "
				+ "is on that list. "
				+ (k === "rating"
