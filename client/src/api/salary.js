...
/* ---------------------------------------------------------------------------
   ...
   **Both documents are drafts and nothing here makes them anything else.**
   `apiCreate` sends `docstatus: 0` outright rather than leaving it to the
   default, and no screen on this dashboard submits anything or touches
   `Salary Slip` or `Payroll Entry`. So a save here is a document sitting on the site waiting
