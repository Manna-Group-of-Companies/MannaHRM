...
export const SCHED_ACTS = {
	...
	list: "The schedules that already exist, on the site. `Auto Email Report` is read here, so an empty "
		+ "table means no schedule has been set up rather than a doctype nobody can reach — and the two "
		+ "are drawn differently.",
	remove: "Nothing here deletes a schedule. Removing one is a decision about who stops receiving a "
		+ "report, and it is made where the schedule is — Delete it from List, on the site.",
};
