...
export const CTC_RATING_MENU = [
  ["upload", "⬆", "Upload Rating from Excel file",
   "<b>This writes salary.</b> A spreadsheet loaded onto CTC is the one action on this page that can "
   + "pay somebody the wrong amount without anybody noticing, and this page proxies GET only — see "
   + "<code>server/index.js</code>. It wants a rule on the site in front of it rather than a file "
   + "picker on a dashboard."],
