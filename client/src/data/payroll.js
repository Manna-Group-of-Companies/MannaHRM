...
export const PSL_FLAGS = [
  ...
  ["itstat", "Include IT Statement", false,
   ...
   + "<code>Employee Tax Exemption Declaration</code>, <code>Salary Slip</code>. The site holds none of "
   + "them and no screen here reads one, so there are two reasons and fixing one would not be "
   + "enough."],
];
...
export const FH_FNF_TABS = [
  ...
  ["settlement", "3", "Final Settlement", "Full and Final Statement",
   ...
   + "and <code>Gratuity</code> beside it. Neither is installed on this site, so there is nothing "
   + "here for this screen to read."],
];
...
export const FH_FNF_FIELDS = [
  ...
  ["FNF Processed Datetime", "<code>Full and Final Statement</code>", "build",
   ...
   + "screen here reads a payroll doctype even once it is."],
];
...
export const SREG_OPTIONS = [
  ...
  ["bank", "Auto Correct Bank Account Number", false,
   ...
   + "switched on anywhere. This page only reads, so it cannot and should not. Corrections belong "
   + "on the desk, where the version trail is."],
];
...
/* ---------------------------------------------------------------------------
   ...
   readable: no screen here reads a payroll doctype and no Payroll Entry
...
export const BT_ACTIONS = [
  ["amounts", "Show Amounts", "\u{1F441}",
   ...
   + "read by any screen here, and no slip has ever been generated "
  ...
  ["file", "Generate Payment File", "⤓",
   ...
   + "format). There is a fourth: the debit side. Nothing here reads <code>Bank Account</code>, so "
   + "the account the money would leave cannot even be named. What this page can do "
...
export const BT_FILE_COLS = [
  ...
  ["Debit account", "Which company account it leaves", "build",
   "The company's <code>Bank Account</code>, which nothing here reads. It is per "
