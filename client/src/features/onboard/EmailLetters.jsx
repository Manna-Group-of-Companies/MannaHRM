...
/* ---------------------------------------------------------------------------
   ...
   **Send is dead, and it is dead for a reason this screen already states.** The
   ...
   was written: nothing here can send mail. There is no mail path in this app
   and no queue to hand a job to, and a `mailto:` cannot carry letters as
   attachments. Adding an SMTP credential to a dashboard is not a feature, it is
   a decision about where this company's mail comes from — and the site already
   has an outgoing mail account and a queue behind it.
...
const SEND_DEAD = "Nothing on this dashboard can send mail. There is no mail path here and no queue "
	+ "to hand the job to, and a mailto: cannot carry letters as attachments. "
			...
			extra={
				<div className="bulk">
					...
					<div className="afnote">
						<b>Send cannot work here.</b> Nothing on this dashboard sends mail — there is no mail path
						here, and a <span className="mono">mailto:</span> cannot carry
