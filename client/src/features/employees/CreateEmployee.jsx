...
import { Desk, Note } from "@/components/ui";
		...
		return (
			<div className="srform">
				...
				<div className="wizdone">
					...
					<Note>
						<b>Not done yet.</b> A new Employee has no salary structure, no leave allocation and
						no shift assignment unless <b>Default Shift</b> was set. None of those is this
						form&rsquo;s to write — the ones that decide pay are drafts on the site at best
						(CLAUDE.md §1).
					</Note>
			...
			<div className="wiz">
				...
				<div className="wizbody">
					...
					{/* Said on the step it is about rather than once at the top, because
					    ...
					    there. */}
					{!NEW_EMP_COPIED.has(here[0]) && (
						<Note>
							<b>Not a copy.</b> Factor HR&rsquo;s {here[1]} page has not been screenshotted
							open — only the circle on its stepper. These are the fields <b>this site</b>{" "}
							holds under that heading: the list to argue with, not a copy of theirs.
						</Note>
					)}
