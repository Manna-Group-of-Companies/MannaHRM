			...
			<div className="repform">
				...
				<div className="repacts">
					...
					{/* Their Download Document dialog — six kinds and two Generates.
					    ...
					    attachments were not read here. **The note had gone stale**:
					    `File` is read, `/files/<name>` serves the bytes under the
					    reader's own session, and On Board's Document register has been
					    opening them for weeks. The desk is still one click away, from
					    inside the dialog. See DownloadDocs.jsx. */}
