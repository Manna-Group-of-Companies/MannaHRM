...
/* ---------------------------------------------------------------------------
   ...
   *Download Employee Picture / Documents*, photographed 4 September 2026.
   ...
   attachments were not read here — a token that can read every file on the site
   being the wrong thing to hand a page on localhost.

   **That note had gone stale, and then its premise went too.** `File` is read
   here and On Board's Document register has been opening scans for weeks. The
   argument it was making was about a *shared API token*, and there is no longer
   one: a scan is fetched under the reader's own session, so the
