...
import { Desk, Empty, NO_SITE, Note, Scroll } from "@/components/ui";
import { deskImport, deskNew, deskUrl } from "@/lib/desk";
import { EMP_IMPORTS, IMPORT_ICON, STATUS_ROWS } from "@/data/employees";
		...
		<>
			<div className="emhead">
				...
				<span className="right">
					{/* Factor HR's own three-step Create Employee, at /employees/new —
					    see features/employees/CreateEmployee.jsx for why this one screen
					    is a form here when every other write on this dashboard is a link
					    to the desk. It still creates the record on the site, under the
					    site's validation; it is the questions that are asked here.

					    The desk link is kept beside it rather than replaced. The wizard
					    asks nine fields of about ninety, and somebody entering a record
					    that needs one of the other eighty should not have to go through
					    three steps to find out it is not there. */}
					{/* Their split button: the whole control adds one person, the caret
					    ...
					    inside a single `.empdrop`, which is the same shape the export
					    control on the reports uses — see ExportMenu in components/ui. */}
					...
					<Desk
						...
						title="Open a blank Employee on the ERPNext site instead — every field it has."
					>
						On the site
					</Desk>
				</span>
