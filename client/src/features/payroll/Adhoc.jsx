...
/* ADHOC PAYMENTS/DEDUCTIONS, photographed 29 August 2026 and drawn here control
   ...
   no payroll doctype is read by this dashboard at all, so each
				...
				<div className="fhtitle row">
					...
					<span className="ics">
						...
						<Desk className="embtn pri adadd" href={s.site && deskNew(s.site, "Additional Salary")}
							label="Add"
							title="One amount, one person, one component, one date. Opens a new Additional Salary on the ERPNext site — nothing here writes payroll, and no payroll doctype is read by this dashboard.">
							+ Add
						</Desk>
